                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="hero-text">
                            ...
                            <h2 class="hero_desc">and I'm <span class="auto-type"></span></h2>
                            <a type="button" class="btn dlr" href="../cv/test.pdf" download="Homer Salazar CV">Download Resume</a>
                            <div class="mt-2">
                                ...
                                <a type="button" class="btn btn-secondary shadow-none btn-linkedin" href=""><i class="fa-brands fa-linkedin fa-lg" target="_blank"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="hero-image " data-aos="zoom-in"  data-aos-duration="1500"> 
                            <img src="../image/home-bg-pic.png" alt="" class="p-0 m-0" width="300">
                        </div>
                    </div>
                </div>                
            </div>
            ...
            <div class="row bg-about">
                ...
                <div class="col-lg-3 mt-4">
                    <div class="about-image-section" data-aos="zoom-in"  data-aos-duration="1500">
                        <div class="card" > 
                            <img src="../image/sample1.jpg" class="imageAboutPage" alt="">
                        </div>
                    </div>
                </div>
                <div class="col"></div>
                <div class="col-lg-6">
                    <div class="about-text-section" data-aos="fade-up">
                        ...
                        <!-- <p> “I am Homer! I’m passionate about software development and I’m skilled in HTML, CSS, JavaScript, and PHP. I’m now looking for a junior dev position as I recently learned how to code by myself.”</p>  -->
                        <p>“I am Homer! Aspiring to become a junior web developer, I am passionately learning HTML, CSS, JavaScript, jQuery, and PHP to create dynamic and interactive websites that not only look visually appealing but also provide seamless user experience.”</p>
